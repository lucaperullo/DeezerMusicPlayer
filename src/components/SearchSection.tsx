    ...
    <>
      {searchresults && searchresults.length === 0 ? (
        <div>
          <img
            style={{ height: "400px" }}
            src="https://pacemindblog.files.wordpress.com/2018/05/75tvqck.gif"
            alt="picazzo"
          />
        ...
        <div style={{ display: "flex", position: "absolute", top: "0" }}>
          <img
            style={{ height: "35px", borderRadius: "50%", margin: "10px" }}
            src={searchresults && searchresults[0].artist.picture}
            alt="search dude why are u lookin at this bug"
          />
          <Input
            onChange={(e) =>
              setTimeout(() => {
        ...
        {searchresults &&
          searchresults.map((result) => (
            ...
            >
              ...
              <Link
                onClick={() => window.location.assign(`/${result.album.id}`)}
                style={{
                  fontSize: "14px",
                  whiteSpace: "nowrap",
                  overflow: "hidden",
